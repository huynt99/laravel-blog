                ...
                <form method="post" action="{{route('panel.post.update',$data['post']->id)}}" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            ...
                            <input class="form-control" name="url_key" placeholder="" value="{{$data['post']->url_key}}" type="text">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control mt-15" name="content" rows="5" placeholder="Textarea" >
                                {{$data['post']->content}}
                            </textarea>
                        </div>
                    </div>
                    <hr>
                    <button class="btn btn-primary" type="submit">{{__('values.edit_post')}}</button>
                </form>
            </div>
        </div>
    </section>
